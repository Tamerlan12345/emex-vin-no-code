  ...
  async parseResults(page) {
    ...
    for (let i = 0; i < limit; i++) {
      try {
        ...
        results.push({
          image: 'data:image/svg+xml;base64,',
          brand: brand || 'N/A',
          article: article || '---',
          name: name || 'Запчасть',
